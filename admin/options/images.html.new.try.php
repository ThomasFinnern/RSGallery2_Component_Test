	...
	static function batchupload($option) {
		...
		*/
        ...
        function CheckFtpPath ()
        {
            ...
            if (form.ftppath.value == '') {
                form.ResultingPath.value = " <?php echo JText::_('COM_RSGALLERY2_FTP_UPLOAD_CHOSEN_BUT_NO_FTP-PATH_PROVIDED');?>" );
                return;
            }
            else
            {
                form.ResultingPath.value = form.ftppath.value;
            }
        }
            ...
            <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="ftppath" value="<?php echo $FTP_path; ?>" size="30" onchange="Joomla.CheckFtpPath();" onclick="Joomla.CheckFtpPath();" />
                        <input type="text" name="ftppath2" value="<?php echo $FTP_path; ?>" size="30" onchange="javascript:CheckFtpPath();" onclick="javascript:.CheckFtpPath();" />
                        <input type="text" name="ftppath3" value="<?php echo $FTP_path; ?>" size="30" onchange="this.form.CheckFtpPath();" onclick="this.form.CheckFtpPath();" />
                        <div>
                            this.form.CheckFtpPath&nbsp;
                            javascript::&nbsp;
                            resulting path: <label name="ResultingPath" >undefined</label>&nbsp;
                            <?php echo JHtml::tooltip( "", "", "Joomla3x/media/system/images/icon_error.png" ); ?>&nbsp;
                        </div>
                    </td>
                </tr>
                <tr>
